...
parser.add_argument("-npz_dir", type=str, default="/data1/hp/medsamdata/CT/split_data/AbdomenCT1K/train",
                    help="Path to the directory containing preprocessed .npz data, [default: data/npz/MedSAM_train/CT_Abd]")
parser.add_argument("-npy_dir", type=str, default="/data/hp/medsam_auto/train_data/CT/AbdomenCT1K",
